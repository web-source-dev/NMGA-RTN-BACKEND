...
const createLogMessage = async (action, resource, context = {}, tokenInfo) => {
    ...
    const actionMessages = {
        ...
        'member_commitment_window_closing_reminder_sent': `System sent ${context.timeRemaining || 'closing'} reminder to ${context.userName || 'member'} for ${context.commitmentMonth || 'current month'}, alerting them that the commitment window will close soon and they should finalize their purchase commitments`,
